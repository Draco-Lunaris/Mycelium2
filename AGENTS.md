...
- Next: post-Phase-9 — first real CI run + GHCR publish on push; optional follow-ups: action SHA-pinning, mkdocs, automated semver tooling, bookshelf visibility toggle.